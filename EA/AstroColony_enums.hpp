...
enum class ESettingOptionType {
    ...
    GameplayFOV = 25,
    GameplayVerticalMouseSensitivity = 26,
    GameplayVerticalMouseInverted = 27,
    GameplayHorizontalMouseSensitivity = 28,
    GameplayHorizontalMouseInverted = 29,
    InterfaceLanguage = 30,
    InterfaceUIScaling = 31,
    InterfaceShowTooltips = 32,
    InterfaceShowTutorialMessages = 33,
    InterfaceShowAlerts = 34,
    InterfaceRestoreOpenWindowState = 35,
    KeyMoveForward = 36,
    KeyMoveBackward = 37,
    KeyMoveLeft = 38,
    KeyMoveRight = 39,
    ...
    KeySlowdown = 45,
    KeyTurbo = 46,
    KeyToolSelectNone = 47,
    KeyToolScan = 48,
    KeyToolJetpack = 49,
    KeyToolPickaxe = 50,
    KeyActionInteract = 51,
    KeyActionSelect = 52,
    KeyActionOpen = 53,
    KeyActionClose = 54,
    KeyActionLeave = 55,
    KeyActionCancel = 56,
    KeyActionRemove = 57,
    KeyActionRemoveSelected = 58,
    KeyActionUpgrade = 59,
    KeyActionRotateLeft = 60,
    KeyActionRotateRight = 61,
    KeyInvCategory1 = 62,
    KeyInvCategory2 = 63,
    KeyInvCategory3 = 64,
    KeyInvCategory4 = 65,
    ...
    KeyInvSlot8 = 76,
    KeyUtilityHelp = 77,
    KeyUtilityQuickSave = 78,
    KeyUtilityQuickLoad = 79,
    KeyUIOptons = 80,
    KeyUIInventory = 81,
    KeyUIConstruction = 82,
    KeyUITechnology = 83,
    KeyUIPlayerInfo = 84,
    KeyUIGuidebook = 85,
    KeyUIMap = 86,
