...
class ABP_GamePlayerController_C : public AEHGamePlayerController
{
    ...
    FTimerHandle RebaseTimerHandle;

    bool ShouldRebaseWorldOrigin();
    void IsSmoothDebugActive(bool& Active);
    void UpdateWorldOriginMP();
    bool ShowActors();
    bool HideActors();
    ...
    void InpActEvt_ToggleMouse_K2Node_InputActionEvent_29(FKey Key);
    void InpActEvt_Add_K2Node_InputKeyEvent_10(FKey Key);
    void InpActEvt_Subtract_K2Node_InputKeyEvent_9(FKey Key);
    void InpActEvt_Multiply_K2Node_InputKeyEvent_8(FKey Key);
    void InpActEvt_F12_K2Node_InputKeyEvent_7(FKey Key);
    void InpActEvt_UIOption_K2Node_InputActionEvent_28(FKey Key);
    void InpActEvt_UIOptionEditor_K2Node_InputActionEvent_27(FKey Key);
    void InpActEvt_BreakControl_K2Node_InputActionEvent_26(FKey Key);
    void InpActEvt_BreakControl_K2Node_InputActionEvent_25(FKey Key);
    void InpActEvt_ToolSelect_K2Node_InputActionEvent_24(FKey Key);
    void InpActEvt_ActionClose_K2Node_InputActionEvent_23(FKey Key);
    void InpActEvt_ActionRotateLeft_K2Node_InputActionEvent_22(FKey Key);
    void InpActEvt_ActionRotateRight_K2Node_InputActionEvent_21(FKey Key);
    void InpActEvt_UtilityQuickSave_K2Node_InputActionEvent_20(FKey Key);
    void InpActEvt_UtilityQuickLoad_K2Node_InputActionEvent_19(FKey Key);
    void InpActEvt_F10_K2Node_InputKeyEvent_6(FKey Key);
    void InpActEvt_Nine_K2Node_InputKeyEvent_5(FKey Key);
    void InpActEvt_Zero_K2Node_InputKeyEvent_4(FKey Key);
    void InpActEvt_ToolJetpack_K2Node_InputActionEvent_18(FKey Key);
    void InpActEvt_Home_K2Node_InputKeyEvent_3(FKey Key);
    ...
    void InpActEvt_Turbo_K2Node_InputActionEvent_17(FKey Key);
    ...
    void InpActEvt_UIModHUB_K2Node_InputActionEvent_15(FKey Key);
    ...
    void UniverseChanged(uint8 PreviousIndex, uint8 NewIndex);
    void CustomEvent_0();
