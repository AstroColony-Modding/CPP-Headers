#ifndef UE4SS_SDK_BP_DeciderPawn_HPP
#define UE4SS_SDK_BP_DeciderPawn_HPP

class ABP_DeciderPawn_C : public AEHInteractivePawn
{
    ...
    class UEHDeciderCombinatorObject* DeciderObject;
    ...
    void ExecuteUbergraph_BP_DeciderPawn(int32 EntryPoint);
};
